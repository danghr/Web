...
The book "信息科学技术伦理与道德" (*Ethics and Morality in Information Science and Technology*) is published!
...
Topics include ethical principles, AI decision, big data, privacy, identity, etc.

Readers will be guided to consider the relationship between these new technologys and our society.
This is important for researchers, developers and engineers to keep in mind of evaluating the possible ethical impact when developing new technology.
Meanwhile, the public will also benefit from the contents by appraising the new technology in a rational way, neither over-optimistic nor over pessimistic.
